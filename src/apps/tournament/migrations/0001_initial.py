    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tournament_type', models.CharField(choices=[('single_elimination', 'Single Elimination'), ('league', 'League')], max_length=20)),
                ...
                ('players', models.ManyToManyField(through='tournament.PlayerTournamentScore', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
