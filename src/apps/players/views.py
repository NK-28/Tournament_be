...
def tournament_detail(request, pk):
    ...
    player_tournament = PlayerTournamentScore.objects.filter(tournaments=tournament)
    player_scores = []
    ...
    for player in player_tournament:
        ...
        player_scores.append({"player": player, "score": player_score, "game_results": game_results})
